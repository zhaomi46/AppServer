...
public class JWTTokenManager implements TokenManager {
    ...
    public String createToken(Long userId, Boolean valid) throws Exception {
        ...
        String text0 = encoder.encode(userId.toString().getBytes());
        String text1 = encoder.encode(createDate.toString().getBytes());
        String text2 = encoder.encode(valid.toString().getBytes());
        ...
        String tokenString = encoder.encode(JSON.toJSONString(token).getBytes());
        return tokenString;
    }
    ...
    public TokenModel getToken(String authentication) throws IOException {
        ...
        byte[] bytes = decoder.decodeBuffer(authentication);
